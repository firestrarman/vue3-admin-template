...
section(class="error-page")
  div(class="error-page__inner")
    div(class="error-page__content")
      div(class="error-page__label") {{ label }}
      h1(class="error-page__code") {{ statusCode }}
      h2(class="error-page__title") {{ title }}
      p(class="error-page__description") {{ description }}
      ...
      div(class="error-visual")
        ...
        div(class="error-visual__body")
          div(class="error-visual__summary")
            ...
            div
              div(class="error-visual__status") {{ statusCode }}
              div(class="error-visual__name") {{ visualName }}
...
const visualMeta = computed(() =>
  props.variant === "locked" ? "權限校驗未通過" : "目標路由未匹配"
);
</script>
