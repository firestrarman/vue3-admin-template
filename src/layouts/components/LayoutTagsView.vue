<template lang="pug">
div(class="layout-tabs layout-tabs--card")
  el-scrollbar(
    ref="scrollbarRef"
    ...
    div(class="layout-tabs__list")
      div(
        ...
        span(class="layout-tabs__item-text") {{ translateRouteTitle(tag.title) }}
        span(v-if="!tag.affix" class="layout-tabs__item-close" @click.stop="closeSelectedTag(tag)")
  ...
  div(class="layout-tabs__actions")
    ...
    el-dropdown(trigger="click" @command="handleActionCommand")
      button(type="button" class="layout-tabs__action" aria-label="頁籤操作" title="頁籤操作")
        el-icon(:size="16")
          ArrowDown
